...
const NODES: Record<string, Node> = {
  ...
  siemens: {
    ...
    keywords: ["siemens", "rag", "retrieval", "dissertation", "repair", "industrial", "faiss", "llama"],
    text: "Ronit's MSc dissertation with Siemens Digital Industries: a dual-source RAG assistant that fuses technical manuals and repair logs to diagnose faults, on Llama 3 + FAISS, deployable on-prem so no data leaves the engineer's machine.",
