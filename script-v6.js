document.addEventListener('DOMContentLoaded', () => {
  ...
  function initSkillAnimations() {
    ...
    console.log('initSkillAnimations: bars found:', bars.length);
    const triggerHeight = window.innerHeight * 0.9;
    console.log('initSkillAnimations: triggerHeight:', triggerHeight);

    function checkScroll() {
      const section = document.querySelector('.skills');
      if (!section) {
        console.log('initSkillAnimations: .skills not found');
        return;
      }

      const rect = section.getBoundingClientRect();
      console.log('initSkillAnimations: rect.top:', rect.top, 'triggerHeight:', triggerHeight);
